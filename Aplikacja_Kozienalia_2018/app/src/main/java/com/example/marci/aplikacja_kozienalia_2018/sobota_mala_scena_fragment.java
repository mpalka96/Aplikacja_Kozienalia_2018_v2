...
public class sobota_mala_scena_fragment extends Fragment {
    ...
    public sobota_mala_scena_fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.sobota_mala_scena_fragment, container, false);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lstWykonawca.add(new Wykonawca("SBT TEST", "2018-05-19 20:00", R.drawable.chocolate, "Opis", "Link", "https://goingapp.pl/storage/app/uploads/public/5a5/395/d8b/thumb_167481_600x350_0_0_crop.jpg"));
