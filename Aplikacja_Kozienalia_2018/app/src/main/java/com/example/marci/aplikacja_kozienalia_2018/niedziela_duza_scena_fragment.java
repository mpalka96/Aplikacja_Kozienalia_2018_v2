...
public class niedziela_duza_scena_fragment extends Fragment {
    View v;
    private RecyclerView myrecyclerview;
    private List<Wykonawca> lstWykonawca;


    public niedziela_duza_scena_fragment() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.niedziela_duza_scena_fragment, container, false);
